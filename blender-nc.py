...
kmi = km.keymap_items.new('view2d.zoom', 'TRACKPADPAN', 'ANY')
...
kmi_props_setattr(kmi.properties, 'delta', -1)
kmi = km.keymap_items.new('screen.frame_jump', 'RIGHT_ARROW', 'PRESS', oskey=True)
kmi_props_setattr(kmi.properties, 'end', True)
kmi = km.keymap_items.new('screen.frame_jump', 'LEFT_ARROW', 'PRESS', oskey=True)
...
kmi_props_setattr(kmi.properties, 'end', False)
kmi = km.keymap_items.new('screen.keyframe_jump', 'RIGHT_ARROW', 'PRESS', shift=True, oskey=True)
kmi_props_setattr(kmi.properties, 'next', True)
kmi = km.keymap_items.new('screen.keyframe_jump', 'LEFT_ARROW', 'PRESS', shift=True, oskey=True)
...
kmi = km.keymap_items.new('view3d.move', 'TRACKPADPAN', 'ANY', alt=True)
...
kmi = km.keymap_items.new('view3d.camera_to_view', 'V', 'PRESS', ctrl=True, alt=True)
...
kmi = km.keymap_items.new('view3d.select_circle', 'C', 'PRESS', alt=True, oskey=True)
...
kmi = km.keymap_items.new('node.select_circle', 'C', 'PRESS', alt=True, oskey=True)
...
kmi = km.keymap_items.new('text.run_script', 'RET', 'PRESS', oskey=True)
...
kmi = km.keymap_items.new('clip.select_circle', 'C', 'PRESS', alt=True, oskey=True)
...
kmi = km.keymap_items.new('mask.select_circle', 'C', 'PRESS', alt=True, oskey=True)
